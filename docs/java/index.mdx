...
An  Java API wrapper  allows for the rapid development and integration of Java-based applications with the SignalWire API.
...
<span style={{ fontWeight: "bold" }}>Source Code:</span> <a href="https://github.com/signalwire-community/compatibility-api-java">

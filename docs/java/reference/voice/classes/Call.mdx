...
A Call object represents a response from a call made. You can get instances of a Call object from a [voiceRepository.create()](java/reference/voice/VoiceRepository.mdx/#create), by initiating calls.

...
<span style={{ fontWeight: "bold" }}>Latest Version:</span> <a href="https://packagist.org/packages/signalwire-community/signalwire">
  <img
    className="method-available-tag"
    src="https://img.shields.io/packagist/v/signalwire-community/signalwire.svg?color=brightgreen"
  />
</a>

<br />

<span style={{ fontWeight: "bold" }}>Source Code:</span> <a href="https://github.com/signalwire-community/signalwire-php">

...
This object returned from [`connectAsync`](php/reference/relay_calling/call.mdx#connectasync) method that represents a connecting attempt that is currently active on a call.
...
[`Relay.Calling.ConnectResult`](php/reference/relay_calling/connect_result.mdx) - Final result of the connect attempt.

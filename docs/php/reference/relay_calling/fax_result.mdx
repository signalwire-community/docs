...
This object returned from [`faxReceive`](php/reference/relay_calling/call.mdx#faxreceive) and [`faxSend`](php/reference/relay_calling/call.mdx#faxsend) methods that represents the final result of a sent or received Fax.

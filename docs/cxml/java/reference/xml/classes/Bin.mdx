...
An object that represents response from the creation of a Bin. you get this response from calling [repository.create()](cxml/java/reference/xml/LamlRepository.mdx#create).

...
| `$message` | <span class="method-prop-type">array</span>  | <span class="required-arg">required</span> | Array with your custom data that will be sent to your Consumer's [`onTask`](relay/server-sdk/php/reference/relay_consumer.mdx#ontask) handler. |

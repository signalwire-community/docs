...
`React\Promise\Promise` - `Promise` that will be fulfilled with a [`Relay.Messaging.SendResult`](relay/server-sdk/php/reference/relay_messaging/send_result.mdx) object.

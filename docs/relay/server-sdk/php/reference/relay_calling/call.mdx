...
|      `peer` | <span class="method-prop-type">[`Relay.Calling.Call`](relay/server-sdk/php/reference/relay_calling/call.mdx)</span> | The call your original call is connected to.                                                                            |
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.AnswerResult`](relay/server-sdk/php/reference/relay_calling/answer_result.mdx) object.

**Examples**

```php title="Answer an inbound call and check if it was successful."
<?php
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.ConnectResult`](relay/server-sdk/php/reference/relay_calling/connect_result.mdx) object.

**Examples**

```php title="Try connecting by calling '+18991114444' and '+18991114445' in series."
<?php
...
```php title="Combine serial and parallel calling. Call '+18991114443' first and - if it doesn't answer - try calling in parallel '+18991114444' and '+18991114445'. If none of the devices answer, continue the same process with '+18991114446' and '+18991114447'."
<?php
...
```php title="Try connecting by calling '+18991114444' and '+18991114445' in series playing the US ringtone."
<?php
...
Asynchronous version of [`connect`](relay/server-sdk/php/reference/relay_calling/call.mdx#connect). It does not wait the connect to completes or fails but returns a [`Relay.Calling.ConnectAction`](relay/server-sdk/php/reference/relay_calling/connect_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`connect`](relay/server-sdk/php/reference/relay_calling/call.mdx#connect) for the parameter list.

**Returns**

`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.ConnectAction`](relay/server-sdk/php/reference/relay_calling/connect_action.mdx) object.

**Examples**

```php title="Trying to connect a call by calling in series '+18991114444' and '+18991114445'."
<?php
...
The `detect` method is a generic method for all types of detecting, see [`detectAnsweringMachine`](#detectansweringmachine), [`detectDigit`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectdigit) or [`detectFax`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectfax) for more specific usage.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.DetectResult`](relay/server-sdk/php/reference/relay_calling/detect_result.mdx) object.

**Examples**

```php title="Detect a machine with custom parameters and timeout."
<?php
...
```php title="Detect a Fax setting timeout only."
<?php
...
Asynchronous version of [`detect`](relay/server-sdk/php/reference/relay_calling/call.mdx#detect). It does not wait the detector ends but returns a [`Relay.Calling.DetectAction`](relay/server-sdk/php/reference/relay_calling/detect_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.1+-brightgreen.svg" />

**Parameters**

See [`detect`](relay/server-sdk/php/reference/relay_calling/call.mdx#detect) for the parameter list.

**Returns**

`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.DetectAction`](relay/server-sdk/php/reference/relay_calling/detect_action.mdx) object.

**Examples**

```php title="Detect digits using default parameters. Stop the action immediately."
<?php
...
This is a helper function that refines the use of [`detect`](relay/server-sdk/php/reference/relay_calling/call.mdx#detect). The Promise will be resolved with a [`Relay.Calling.DetectResult`](relay/server-sdk/php/reference/relay_calling/detect_result.mdx) object as soon as the detector decided _who_ answered the call: `MACHINE`, `HUMAN` or `UNKNOWN`.
...
```php title="Perform an AMD and wait until the machine is ready."
<?php
...
Asynchronous version of [`detectAnsweringMachine`](#detectansweringmachine). It does not wait the detector ends but returns a [`Relay.Calling.DetectAction`](relay/server-sdk/php/reference/relay_calling/detect_action.mdx) you can interact with.
...
```php title="Perform an asynchronous AMD on the call. Then stop the action if not completed yet."
<?php
...
This is a helper function that refines the use of [`detect`](relay/server-sdk/php/reference/relay_calling/call.mdx#detect). This simplifies detecting _digits_ on a call.
...
```php title="Detect digits and then write a log with the result."
<?php
...
Asynchronous version of [`detectDigit`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectdigit). It does not wait the detector ends but returns a [`Relay.Calling.DetectAction`](relay/server-sdk/php/reference/relay_calling/detect_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.1+-brightgreen.svg" />

**Parameters**

See [`detectDigit`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectdigit) for the parameter list.
...
```php title="Detect only '1-3' digits asynchronously."
<?php
...
This is a helper function that refines the use of [`detect`](relay/server-sdk/php/reference/relay_calling/call.mdx#detect). This simplifies detecting a _fax_.
...
```php title="Detect fax on the current call."
<?php
...
Asynchronous version of [`detectFax`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectfax). It does not wait the detector ends but returns a [`Relay.Calling.DetectAction`](relay/server-sdk/php/reference/relay_calling/detect_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.1+-brightgreen.svg" />

**Parameters**

See [`detectFax`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectfax) for the parameter list.
...
```php title="Detect fax on the current call. Stop the action immediately."
<?php
...
This is a helper function that refines the use of [`detect`](relay/server-sdk/php/reference/relay_calling/call.mdx#detect). This simplifies detecting a _human_ on the call and is the inverse of [`detectMachine`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectmachine).
...
```php title="Detect a human on the current call."
<?php
...
Asynchronous version of [`detectHuman`](relay/server-sdk/php/reference/relay_calling/call.mdx#detecthuman). It does not wait the detector ends but returns a [`Relay.Calling.DetectAction`](relay/server-sdk/php/reference/relay_calling/detect_action.mdx) you can interact with.
...
See [`detectHuman`](relay/server-sdk/php/reference/relay_calling/call.mdx#detecthuman) for the parameter list.
...
```php title="Detect a human on the current call. Stop the action immediately."
<?php
...
This is a helper function that refines the use of [`detect`](relay/server-sdk/php/reference/relay_calling/call.mdx#detect). This simplifies detecting a _machine_ on the call and is the inverse of [`detectHuman`](relay/server-sdk/php/reference/relay_calling/call.mdx#detecthuman).
...
```php title="Detect a machine on the current call."
<?php
...
Asynchronous version of [`detectMachine`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectmachine). It does not wait the detector ends but returns a [`Relay.Calling.DetectAction`](relay/server-sdk/php/reference/relay_calling/detect_action.mdx) you can interact with.

**Deprecated since**: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.2-important.svg" /> Use [`detectAnsweringMachineAsync`](#detectansweringmachineasync) instead.

**Parameters**

See [`detectMachine`](relay/server-sdk/php/reference/relay_calling/call.mdx#detectmachine) for the parameter list.
...
```php title="Detect a machine on the current call. Stop the action immediately."
<?php
...
This will start a call that was created with [`newCall`](relay/server-sdk/php/reference/relay_calling/index.mdx#newcall) and waits until the Call has been answered or hung up.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.FaxResult`](relay/server-sdk/php/reference/relay_calling/fax_result.mdx) object.

**Examples**

```php title="Receiving a fax on the call and print logs for URL and number of received pages."
<?php
...
Asynchronous version of [`faxReceive`](relay/server-sdk/php/reference/relay_calling/call.mdx#faxreceive). It does not wait the fax to be received but returns [`Relay.Calling.FaxAction`](relay/server-sdk/php/reference/relay_calling/fax_action.mdx) you can interact with.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.FaxAction`](relay/server-sdk/php/reference/relay_calling/fax_action.mdx) object.

**Examples**

```php title="Trying to receive a fax and then stop it."
<?php
...
```php title="Sending a fax on the call and print logs the number of sent pages."
<?php
...
Asynchronous version of [`faxSend`](relay/server-sdk/php/reference/relay_calling/call.mdx#faxsend). It does not wait the fax to be sent but returns a [`Relay.Calling.FaxAction`](relay/server-sdk/php/reference/relay_calling/fax_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`faxSend`](relay/server-sdk/php/reference/relay_calling/call.mdx#faxsend) for the parameter list.
...
```php title="Trying to send a fax and then stop it."
<?php
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.HangupResult`](relay/server-sdk/php/reference/relay_calling/hangup_result.mdx) object.

**Examples**

```php title="Hangup the current call and check if it was successful."
<?php
...
|            |                                                |                                            |                                                                                                            |
| ---------- | ---------------------------------------------- | ------------------------------------------ | ---------------------------------------------------------------------------------------------------------- |
| `$event`   | <span class="method-prop-type">string</span>   | <span class="required-arg">required</span> | Event name. Full list of events [`Relay.Calling.Call` Events](relay/server-sdk/php/reference/relay_calling/call.mdx#events) |
...
[`Relay.Calling.Call`](relay/server-sdk/php/reference/relay_calling/call.mdx) - The call object itself.

**Examples**

```php title="Subscribe to the 'answered' and 'ended' events for a given call."
<?php
...
```php title="Subscribe to the call 'ended' state change and then, remove the event handler."
<?php
...
The `play` method is a generic method for all types of playing, see [`playAudio`](relay/server-sdk/php/reference/relay_calling/call.mdx#playaudio), [`playSilence`](relay/server-sdk/php/reference/relay_calling/call.mdx#playsilence), [`playTTS`](relay/server-sdk/php/reference/relay_calling/call.mdx#playtts) or [`playRingtone`](relay/server-sdk/php/reference/relay_calling/call.mdx#playringtone) for more specific usage.
...
| `name`     | <span class="method-prop-type">string</span> | <span class="required-arg">required</span> | The name of the ringtone. See [`ringtones`](relay/server-sdk/php/reference/relay_calling/call.mdx#ringtones) for the supported values. |
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PlayResult`](relay/server-sdk/php/reference/relay_calling/play_result.mdx) object.

**Examples**

```php title="Play multiple media elements in the call."
<?php
...
Asynchronous version of [`play`](#play). It does not wait the _playing_ to completes but returns a [`Relay.Calling.PlayAction`](relay/server-sdk/php/reference/relay_calling/play_action.mdx) you can interact with.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PlayAction`](relay/server-sdk/php/reference/relay_calling/play_action.mdx) object.

**Examples**

```php title="Play multiple media elements in the call and then stop it."
<?php
...
```php title="Play an Mp3 file using the signature with a 'string' as parameter."
<?php
...
```php title="Play an Mp3 file setting volume level to 4dB. Require v2.3+."
<?php
...
Asynchronous version of [`playAudio`](relay/server-sdk/php/reference/relay_calling/call.mdx#playaudio). It does not wait the _playing_ to completes but returns a [`Relay.Calling.PlayAction`](relay/server-sdk/php/reference/relay_calling/play_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`playAudio`](relay/server-sdk/php/reference/relay_calling/call.mdx#playaudio) for the parameter list.
...
```php title="Play an Mp3 file and stop it after 5 seconds."
<?php
...
```php title="Play an Mp3 file setting the volume and stop it after 5 seconds."
<?php
...
```php title="Play a single US ringtone."
<?php
...
Asynchronous version of [`playRingtone`](relay/server-sdk/php/reference/relay_calling/call.mdx#playringtone). It does not wait the _playing_ to completes but returns a [`Relay.Calling.PlayAction`](relay/server-sdk/php/reference/relay_calling/play_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.3+-brightgreen.svg" />

**Parameters**

See [`playRingtone`](relay/server-sdk/php/reference/relay_calling/call.mdx#playringtone) for the parameter list.
...
```php title="Play US ringtone for 30 seconds, if 'Agent' is available, stop the play."
<?php
...
```php title="Play silence for 10 seconds."
<?php
...
Asynchronous version of [`playSilence`](relay/server-sdk/php/reference/relay_calling/call.mdx#playsilence). It does not wait the _playing_ to completes but returns a [`Relay.Calling.PlayAction`](relay/server-sdk/php/reference/relay_calling/play_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`playSilence`](relay/server-sdk/php/reference/relay_calling/call.mdx#playsilence) for the parameter list.
...
```php title="Play silence for 60 seconds, if 'Agent' is available, stop the play."
<?php
...
Asynchronous version of [`playTTS`](relay/server-sdk/php/reference/relay_calling/call.mdx#playtts). It does not wait the _playing_ to completes but returns a [`Relay.Calling.PlayAction`](relay/server-sdk/php/reference/relay_calling/play_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`playTTS`](relay/server-sdk/php/reference/relay_calling/call.mdx#playtts) for the parameter list.
...
```php title="Play TTS and stop it after 5 seconds."
<?php
...
The `prompt` method is a generic method, see [`promptAudio`](relay/server-sdk/php/reference/relay_calling/call.mdx#promptaudio), [`promptTTS`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompttts) or [`promptRingtone`](relay/server-sdk/php/reference/relay_calling/call.mdx#promptringtone) for more specific usage.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PromptResult`](relay/server-sdk/php/reference/relay_calling/prompt_result.mdx) object.

**Examples**

```php title="Ask user to enter their PIN and collect the digits."
<?php
...
Asynchronous version of [`prompt`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompt). It does not wait the _collection_ to completes but returns a [`Relay.Calling.PromptAction`](relay/server-sdk/php/reference/relay_calling/prompt_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`prompt`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompt) for the parameter list.

**Returns**

`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PromptAction`](relay/server-sdk/php/reference/relay_calling/prompt_action.mdx) object.
...
This is a helper function that refines the use of [`prompt`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompt).<br/>This function simplifies playing an audio file while collecting user's input from the call, such as _digits_ and _speech_.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

You can set all the properties that [`prompt`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompt) accepts replacing `media` with:
...
```php title="Collect user's digits while playing an Mp3 file."
<?php
...
Asynchronous version of [`promptAudio`](relay/server-sdk/php/reference/relay_calling/call.mdx#promptaudio). It does not wait the _collection_ to completes but returns a [`Relay.Calling.PromptAction`](relay/server-sdk/php/reference/relay_calling/prompt_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`promptAudio`](relay/server-sdk/php/reference/relay_calling/call.mdx#promptaudio) for the parameter list.
...
This is a helper function that refines the use of [`prompt`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompt).<br/>This function simplifies playing ringtone while collecting user's input from the call, such as _digits_ and _speech_.
...
```php title="Play US ringtone for 30 seconds while collect digits."
<?php
...
Asynchronous version of [`promptRingtone`](relay/server-sdk/php/reference/relay_calling/call.mdx#promptringtone). It does not wait the _collection_ to completes but returns a [`Relay.Calling.PromptAction`](relay/server-sdk/php/reference/relay_calling/prompt_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.3+-brightgreen.svg" />

**Parameters**

See [`promptRingtone`](relay/server-sdk/php/reference/relay_calling/call.mdx#promptringtone) for the parameter list.
...
```php title="Play US ringtone for 30 seconds while collect digits in asynchronous."
<?php
...
This is a helper function that refines the use of [`prompt`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompt).<br/>This function simplifies playing TTS while collecting user's input from the call, such as _digits_ and _speech_.
...
Asynchronous version of [`promptTTS`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompttts). It does not wait the _collection_ to completes but returns a [`Relay.Calling.PromptAction`](relay/server-sdk/php/reference/relay_calling/prompt_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`promptTTS`](relay/server-sdk/php/reference/relay_calling/call.mdx#prompttts) for the parameter list.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.RecordResult`](relay/server-sdk/php/reference/relay_calling/record_result.mdx) object.

**Examples**

```php title="Start recording audio in the call for both direction in stereo mode, if successful, grab 'url', 'duration' and 'size' from the RecordResult object."
<?php
...
Asynchronous version of [`record`](relay/server-sdk/php/reference/relay_calling/call.mdx#record). It does not wait the end of recording but returns a [`Relay.Calling.RecordAction`](relay/server-sdk/php/reference/relay_calling/record_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.0+-brightgreen.svg" />

**Parameters**

See [`record`](relay/server-sdk/php/reference/relay_calling/call.mdx#record) for the parameter list.

**Returns**

`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.RecordAction`](relay/server-sdk/php/reference/relay_calling/record_action.mdx) object.

**Examples**

```php title="Start recording audio in the call for both direction in stereo mode and then stop it using the RecordAction object."
<?php
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.SendDigitsResult`](relay/server-sdk/php/reference/relay_calling/send_digits_result.mdx) object.

**Examples**

```php title="Send some digits."
<?php
...
Asynchronous version of [`sendDigits`](relay/server-sdk/php/reference/relay_calling/call.mdx#senddigits). It does not wait for the sending event to complete, and immediately returns a [`Relay.Calling.SendDigitsAction`](relay/server-sdk/php/reference/relay_calling/send_digits_action.mdx) object you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.2+-brightgreen.svg" />

**Parameters**

See [`sendDigits`](relay/server-sdk/php/reference/relay_calling/call.mdx#senddigits) for the parameter list.

**Returns**

`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.SendDigitsAction`](relay/server-sdk/php/reference/relay_calling/send_digits_action.mdx).

**Examples**

```php title="Send some digits and then check if the operation is completed using the SendDigitsAction object."
<?php
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.TapResult`](relay/server-sdk/php/reference/relay_calling/tap_result.mdx) object.

**Examples**

```php title="Tapping audio from the call, if successful, print both source and destination devices from the TapResult object."
<?php
...
Asynchronous version of [`tap`](relay/server-sdk/php/reference/relay_calling/call.mdx#tap). It does not wait the end of tapping but returns a [`Relay.Calling.TapAction`](relay/server-sdk/php/reference/relay_calling/tap_action.mdx) you can interact with.

Available In: <img class="method-available-tag" src="https://img.shields.io/badge/-v2.1+-brightgreen.svg" />

**Parameters**

See [`tap`](relay/server-sdk/php/reference/relay_calling/call.mdx#tap) for the parameter list.

**Returns**

`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.TapAction`](relay/server-sdk/php/reference/relay_calling/tap_action.mdx) object.

**Examples**

```php title="Tapping audio from the call and then stop it using the TapAction object."
<?php
...
```php title="Wait for 'ending' or 'ended' events."
<?php
...
```php title="Wait for the 'answered' event."
<?php
...
```php title="Wait for the 'ended' event."
<?php
...
```php title="Wait for the 'ending' event."
<?php

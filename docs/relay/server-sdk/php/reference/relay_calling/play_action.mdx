...
[`Relay.Calling.PlayResult`](relay/server-sdk/php/reference/relay_calling/play_result.mdx) - Final result of the playing.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PlayPauseResult`](relay/server-sdk/php/reference/relay_calling/play_pause_result.mdx) object.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PlayResumeResult`](relay/server-sdk/php/reference/relay_calling/play_resume_result.mdx) object.
...
> Note: you can avoid the _callback hell_ using these methods in a [`Relay.Consumer`](relay/server-sdk/php/reference/relay_consumer.mdx).
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PlayVolumeResult`](relay/server-sdk/php/reference/relay_calling/play_volume_result.mdx) object.

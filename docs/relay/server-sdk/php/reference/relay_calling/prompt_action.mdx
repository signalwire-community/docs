...
[`Relay.Calling.PromptResult`](relay/server-sdk/php/reference/relay_calling/prompt_result.mdx) - Final result of the prompt attempt.
...
`React\Promise\Promise` - Promise object that will be fulfilled with a [`Relay.Calling.PromptVolumeResult`](relay/server-sdk/php/reference/relay_calling/prompt_volume_result.mdx) object.
